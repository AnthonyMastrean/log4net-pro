...
using log4net.ExceptionMessageMatch;
using Machine.Specifications;

namespace log4net.Addons.Specs
{
    [Subject(typeof(ExceptionMessageMatchFilter))]
    public class When_logging_an_exception_matching_the_filter
    {
        Establish context = () =>
        {
        ...
        Because of = () => _log.Error("There was an error.", new SocketException((int)SocketError.ConnectionReset));

        It should_not_append_this_event = () => _appender.GetEvents().Length.ShouldEqual(0);
