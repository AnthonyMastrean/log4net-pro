...
{
    public class ExtendedLogManager
    {
        /// <summary>
        /// The wrapper map to use to hold the <see cref="ExtendedLogImpl"/> objects
        /// </summary>
        private static readonly WrapperMap WrapperMap = new WrapperMap(new WrapperCreationHandler(WrapperCreationHandler));

        /// <summary>
        /// Prevents a default instance of the <see cref="ExtendedLogManager"/> class from being created.
        /// </summary>
        private ExtendedLogManager()
        {
        }
        ...
        public static IExtendedLog Exists(string name)
        {
        ...
        /// <param name="name">The fully qualified logger name to look for</param>
        /// <returns>The logger found, or null</returns>
        public static IExtendedLog Exists(string domain, string name)
        {
        ...
        /// <param name="name">The fully qualified logger name to look for</param>
        /// <returns>The logger found, or null</returns>
        public static IExtendedLog Exists(Assembly assembly, string name)
        {
        ...
        public static IExtendedLog[] GetCurrentLoggers()
        {
        ...
        /// </remarks>
        /// <returns>All the defined loggers</returns>
        public static IExtendedLog[] GetCurrentLoggers(string domain)
        {
        ...
        /// </remarks>
        /// <returns>All the defined loggers</returns>
        public static IExtendedLog[] GetCurrentLoggers(Assembly assembly)
        {
        ...
        /// <param name="name">The name of the logger to retrieve.</param>
        /// <returns>the logger with the name specified</returns>
        public static IExtendedLog GetLogger(string domain, string name)
        {
        ...
        /// <param name="name">The name of the logger to retrieve.</param>
        /// <returns>the logger with the name specified</returns>
        public static IExtendedLog GetLogger(Assembly assembly, string name)
        {
        ...
        /// be used as the name of the logger to retrieve.</param>
        /// <returns>the logger with the name specified</returns>
        public static IExtendedLog GetLogger(string domain, Type type)
        {
        ...
        /// be used as the name of the logger to retrieve.</param>
        /// <returns>the logger with the name specified</returns>
        public static IExtendedLog GetLogger(Assembly assembly, Type type)
        {
        ...
        private static IExtendedLog WrapLogger(ILogger logger)
        {
            return (IExtendedLog) WrapperMap.GetWrapper(logger);
        }
        ...
        {
            return new ExtendedLogImpl(logger);
        }
